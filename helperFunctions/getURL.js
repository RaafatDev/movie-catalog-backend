...
const getURL = (kind, movieId, isMovie) => {
  //
  // console.log("getUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU", kind, movieId, isMovie);
  ...
  if (kind === "TMDB_MOVIE") {
    ...
    url = `https://api.themoviedb.org/3/${type}/${movieId}?api_key=${process.env.TMDB_API_KEY}&append_to_response=videos,images,credits,external_ids&include_image_language=en,null`;
